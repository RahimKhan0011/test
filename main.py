...
def main():
    ...
    if is_audio_folder:
        ...
        description = f"[center][b][size=5][color=#59E817][font=Oswald]MediaInfo[/color][/size][/b][/center][b][mediainfo]\n{mediainfo_text}[/mediainfo]\n[center][/b][b][size=5][color=#59E817]Screenshots[/color][/size][/b][/center]\n[center]\n{ss_bbcode}[/center][/font]"
